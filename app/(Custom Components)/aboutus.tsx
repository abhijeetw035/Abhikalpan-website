      ...
      <div className="min-h-screen bg-gradient-to-r from blue-900 to-teal-700 flex items-center text-left gap-[20px] m-0 w-[300vh] ">
        <div className="p-8 text-left">
          ...
          <p className="text-lg text-white max-w-2xl mx-auto mb-8">
            ...
            what it builds. It’s central India’s biggest technical extravaganza
            for creating, nurturing and fueling one’s interest in various
            domains of computer science, robotics, electronics, gaming and
            design. In conjunction with the various technical events, various
            informal events keep the fest alive. The events that invite the
            footfall of thousands include Robowar, Circuit master, Brand
            presentation, Astronomy quiz amongst others.
          </p>
